...
DEFAULT_NEEDS = [
    ...
    "叹き・悼み", "インスピレーション・直感", "平和・調和", "ただ在ること", "流れ・フロー", 
    "秩序", "平等・公平", "美", "身体の安全", "安心", 
...
st.markdown("<div style='font-size: 14px; color: #888888; margin-top: -15px; margin-bottom: 10px;'>全ニーズオープン版 Ver1.00</div>", unsafe_allow_html=True)
